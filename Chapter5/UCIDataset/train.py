...
print(np.var(np.squeeze(X_train), axis=0))
print("===================")
sys.exit(0)
...
model = Sequential()
model.add(Dense(64, activation="tanh", input_shape=(1, in_dims)))
...
bayes_model.save("PosteriorModels/VOGN_%s_Model"%(dataset_string))
